...
public class TestSuiteBase {
    ...
    public static final String H2_TEST_URL = "jdbc:h2:mem:assignment3-junit";
    public static final String H2_SERVER_URL = "jdbc:h2:tcp://localhost:12345/~/assignment3-junit";
